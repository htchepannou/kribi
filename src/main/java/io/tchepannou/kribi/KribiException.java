...
public class KribiException extends RuntimeException {
    ...
    public static final String LOAD_BALANCER_NOT_FOUND = "LOAD_BALANCER_NOT_FOUND";
    public static final String TOO_MANY_INSTANCES_DEPLOYED = "TOO_MANY_INSTANCES_DEPLOYED";
